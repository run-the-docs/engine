#!/usr/bin/env python3
"""Mix TTS voice + SFX + background music for K8s Ep11: DaemonSets & Jobs"""
import numpy as np
...
# Load timing
with open('/tmp/k8s_ep11_timing.json') as f:
    timing_data = json.load(f)
total_dur = timing_data['total_duration']

# Load voice
voice = load_wav('/tmp/k8s_ep11_voice.wav', SR)
...
# Sound design
print("Mixing SFX...")
mix_sfx('/tmp/k8s_ep11_impact.wav', insert_time_s=2.0, volume=0.55)   # hook thud at t=2s
mix_sfx('/tmp/k8s_ep11_chime.wav',  insert_time_s=52.0, volume=0.45)  # payoff chime
...
output_path = '/tmp/k8s_ep11_mixed.wav'
