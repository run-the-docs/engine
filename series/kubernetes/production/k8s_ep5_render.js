#!/usr/bin/env node
/**
 * Render k8s_ep5.html using Playwright + canvas.toDataURL()
...
async function main() {
  ...
  const htmlPath = `file:///tmp/k8s_ep5.html`;
