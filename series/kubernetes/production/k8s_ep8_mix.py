#!/usr/bin/env python3
"""Mix TTS voice + SFX + background music for K8s Ep8: Persistent Volumes"""
import numpy as np
...
# Load timing
with open('/tmp/k8s_ep8_timing.json') as f:
    timing_data = json.load(f)
total_dur = timing_data['total_duration']

# Load voice
voice = load_wav('/tmp/k8s_ep8_voice.wav', SR)
...
# Sound design
# Hook impact at t=2s (data-gone moment)
# Payoff chime around t=51.77s (when "Pod dies. Data stays." starts)
print("Mixing SFX...")
mix_sfx('/tmp/k8s_ep8_impact_thud.wav',     insert_time_s=2.0,   volume=0.55)
mix_sfx('/tmp/k8s_ep8_ascending_chime.wav', insert_time_s=51.77, volume=0.45)
...
output_path = '/tmp/k8s_ep8_mixed.wav'
