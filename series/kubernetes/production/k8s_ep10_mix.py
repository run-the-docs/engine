#!/usr/bin/env python3
"""Mix TTS voice + SFX + background music for K8s Ep10: StatefulSets"""
import numpy as np
...
# Load timing
with open('/tmp/k8s_ep10_timing.json') as f:
    timing_data = json.load(f)
total_dur = timing_data['total_duration']

# Load voice
voice = load_wav('/tmp/k8s_ep10_voice.wav', SR)
...
# Sound design
# Hook impact thud at t=2s
# Payoff ascending chime at t=47.25s (when "Stateless workload?" starts)
print("Mixing SFX...")
mix_sfx('/tmp/k8s_ep10_impact_thud.wav',     insert_time_s=2.0,   volume=0.55)
mix_sfx('/tmp/k8s_ep10_ascending_chime.wav', insert_time_s=47.25, volume=0.45)
...
output_path = '/tmp/k8s_ep10_mixed.wav'
