#!/usr/bin/env python3
"""Mix TTS voice + SFX + background music for K8s Ep6: ConfigMaps"""
import numpy as np
...
# Load timing
with open('/tmp/k8s_ep6_timing.json') as f:
    timing_data = json.load(f)
total_dur = timing_data['total_duration']

# Load voice
voice = load_wav('/tmp/k8s_ep6_voice.wav', SR)
...
# Sound design
# Hook impact at t=2s (voice starts saying "Same code.")
# Payoff chime at t=86s (payoff section "One image.")
print("Mixing SFX...")
mix_sfx('/tmp/k8s_ep6_impact_thud.wav',     insert_time_s=2.0,   volume=0.55)
mix_sfx('/tmp/k8s_ep6_ascending_chime.wav', insert_time_s=86.5,  volume=0.45)
...
output_path = '/tmp/k8s_ep6_mixed.wav'
