#!/usr/bin/env python3
"""Mix TTS voice + SFX + background music for K8s Ep9: Ingress"""
import numpy as np
...
# Load voice
voice = load_wav('/tmp/k8s_ep9_voice.wav', SR)
...
# Hook impact at t=2s (one IP moment)
# Payoff chime when routing rules payoff arrives (~segment 8, t~37.4s)
print("Mixing SFX...")
mix_sfx('/tmp/k8s_ep9_impact_thud.wav',     insert_time_s=2.0,   volume=0.55)
mix_sfx('/tmp/k8s_ep9_ascending_chime.wav', insert_time_s=37.39, volume=0.45)
...
output_path = '/tmp/k8s_ep9_mixed.wav'
